...
pub fn eval_composition_polynomial_inner(
    ...
    // Compute powers.
    pow[0] = point.pow_felt(&(global_values.trace_length.floor_div(&felt_nonzero!(FELT_4096))));
    pow[1] = pow[0] * pow[0]; // pow(point, (safe_div(global_values.trace_length, 2048))).
    pow[2] = pow[1] * pow[1]; // pow(point, (safe_div(global_values.trace_length, 1024))).
    pow[3] = pow[2] * pow[2]; // pow(point, (safe_div(global_values.trace_length, 512))).
    pow[4] = pow[3] * pow[3]; // pow(point, (safe_div(global_values.trace_length, 256))).
    pow[5] = pow[4] * pow[4]; // pow(point, (safe_div(global_values.trace_length, 128))).
    pow[6] = pow[5] * pow[5]; // pow(point, (safe_div(global_values.trace_length, 64))).
    pow[7] = pow[6] * pow[6]; // pow(point, (safe_div(global_values.trace_length, 32))).
    pow[8] = pow[7] * pow[7]; // pow(point, (safe_div(global_values.trace_length, 16))).
    pow[9] = pow[8] * pow[8]; // pow(point, (safe_div(global_values.trace_length, 8))).
    pow[10] = pow[9] * pow[9]; // pow(point, (safe_div(global_values.trace_length, 4))).
    pow[11] = pow[10] * pow[10]; // pow(point, (safe_div(global_values.trace_length, 2))).
    pow[12] = pow[11] * pow[11]; // pow(point, global_values.trace_length).
    pow[13] = trace_generator.pow_felt(&(global_values.trace_length - FELT_512));
    pow[14] = trace_generator.pow_felt(&(global_values.trace_length - FELT_256));
    pow[15] = trace_generator.pow_felt(&(global_values.trace_length - FELT_4096));
    pow[16] = trace_generator.pow_felt(&(global_values.trace_length - FELT_4));
    pow[17] = trace_generator.pow_felt(&(global_values.trace_length - FELT_2));
    pow[18] = trace_generator.pow_felt(&(global_values.trace_length - FELT_16));
    pow[19] =
        trace_generator.pow_felt(&(global_values.trace_length.floor_div(&felt_nonzero!(FELT_2))));
    pow[20] = trace_generator
    ...
    pow[22] = pow[21] * pow[21]; // pow(trace_generator, (safe_div(global_values.trace_length, 32))).
    pow[23] = pow[21] * pow[22]; // pow(trace_generator, (safe_div((safe_mult(3, global_values.trace_length)), 64))).
    pow[24] = pow[21] * pow[23]; // pow(trace_generator, (safe_div(global_values.trace_length, 16))).
    pow[25] = pow[21] * pow[24]; // pow(trace_generator, (safe_div((safe_mult(5, global_values.trace_length)), 64))).
    pow[26] = pow[21] * pow[25]; // pow(trace_generator, (safe_div((safe_mult(3, global_values.trace_length)), 32))).
    pow[27] = pow[19] * pow[26]; // pow(trace_generator, (safe_div((safe_mult(19, global_values.trace_length)), 32))).
    pow[28] = pow[21] * pow[26]; // pow(trace_generator, (safe_div((safe_mult(7, global_values.trace_length)), 64))).
    pow[29] = pow[21] * pow[28]; // pow(trace_generator, (safe_div(global_values.trace_length, 8))).
    pow[30] = pow[19] * pow[29]; // pow(trace_generator, (safe_div((safe_mult(5, global_values.trace_length)), 8))).
    pow[31] = pow[21] * pow[29]; // pow(trace_generator, (safe_div((safe_mult(9, global_values.trace_length)), 64))).
    pow[32] = pow[21] * pow[31]; // pow(trace_generator, (safe_div((safe_mult(5, global_values.trace_length)), 32))).
    pow[33] = pow[19] * pow[32]; // pow(trace_generator, (safe_div((safe_mult(21, global_values.trace_length)), 32))).
    pow[34] = pow[21] * pow[32]; // pow(trace_generator, (safe_div((safe_mult(11, global_values.trace_length)), 64))).
    pow[35] = pow[21] * pow[34]; // pow(trace_generator, (safe_div((safe_mult(3, global_values.trace_length)), 16))).
    pow[36] = pow[19] * pow[35]; // pow(trace_generator, (safe_div((safe_mult(11, global_values.trace_length)), 16))).
    pow[37] = pow[21] * pow[35]; // pow(trace_generator, (safe_div((safe_mult(13, global_values.trace_length)), 64))).
    pow[38] = pow[21] * pow[37]; // pow(trace_generator, (safe_div((safe_mult(7, global_values.trace_length)), 32))).
    pow[39] = pow[19] * pow[38]; // pow(trace_generator, (safe_div((safe_mult(23, global_values.trace_length)), 32))).
    pow[40] = pow[21] * pow[38]; // pow(trace_generator, (safe_div((safe_mult(15, global_values.trace_length)), 64))).
    pow[41] = pow[22] * pow[39]; // pow(trace_generator, (safe_div((safe_mult(3, global_values.trace_length)), 4))).
    pow[42] = pow[22] * pow[41]; // pow(trace_generator, (safe_div((safe_mult(25, global_values.trace_length)), 32))).
    pow[43] = pow[22] * pow[42]; // pow(trace_generator, (safe_div((safe_mult(13, global_values.trace_length)), 16))).
    pow[44] = pow[22] * pow[43]; // pow(trace_generator, (safe_div((safe_mult(27, global_values.trace_length)), 32))).
    pow[45] = pow[22] * pow[44]; // pow(trace_generator, (safe_div((safe_mult(7, global_values.trace_length)), 8))).
    pow[46] = pow[22] * pow[45]; // pow(trace_generator, (safe_div((safe_mult(29, global_values.trace_length)), 32))).
    pow[47] = pow[22] * pow[46]; // pow(trace_generator, (safe_div((safe_mult(15, global_values.trace_length)), 16))).
    pow[48] = pow[21] * pow[47]; // pow(trace_generator, (safe_div((safe_mult(61, global_values.trace_length)), 64))).
    pow[49] = pow[21] * pow[48]; // pow(trace_generator, (safe_div((safe_mult(31, global_values.trace_length)), 32))).
    pow[50] = pow[21] * pow[49]; // pow(trace_generator, (safe_div((safe_mult(63, global_values.trace_length)), 64))).

    // Compute domains.
    let domain0 = pow[12] - FELT_1;
    let domain1 = pow[11] - FELT_1;
    let domain2 = pow[10] - FELT_1;
    let domain3 = pow[9] - FELT_1;
    let domain4 = pow[8] - pow[47];
    let domain5 = pow[8] - FELT_1;
    let domain6 = pow[7] - FELT_1;
    let domain7 = pow[6] - FELT_1;
    let domain8 = pow[5] - FELT_1;
    let domain9 = pow[4] - FELT_1;
    let domain10 = pow[4] - pow[41];
    let mut temp = pow[4] - pow[21];
    temp = temp * (pow[4] - pow[22]);
    temp = temp * (pow[4] - pow[23]);
    temp = temp * (pow[4] - pow[24]);
    temp = temp * (pow[4] - pow[25]);
    temp = temp * (pow[4] - pow[26]);
    temp = temp * (pow[4] - pow[28]);
    temp = temp * (pow[4] - pow[29]);
    temp = temp * (pow[4] - pow[31]);
    temp = temp * (pow[4] - pow[32]);
    temp = temp * (pow[4] - pow[34]);
    temp = temp * (pow[4] - pow[35]);
    temp = temp * (pow[4] - pow[37]);
    temp = temp * (pow[4] - pow[38]);
    temp = temp * (pow[4] - pow[40]);
    let domain11 = temp * (domain9);
    let domain12 = pow[3] - FELT_1;
    let domain13 = pow[3] - pow[41];
    let domain14 = pow[2] - pow[49];
    let mut temp = pow[2] - pow[36];
    temp = temp * (pow[2] - pow[39]);
    temp = temp * (pow[2] - pow[41]);
    temp = temp * (pow[2] - pow[42]);
    temp = temp * (pow[2] - pow[43]);
    temp = temp * (pow[2] - pow[44]);
    temp = temp * (pow[2] - pow[45]);
    temp = temp * (pow[2] - pow[46]);
    temp = temp * (pow[2] - pow[47]);
    let domain15 = temp * (domain14);
    let domain16 = pow[2] - FELT_1;
    let mut temp = pow[2] - pow[48];
    temp = temp * (pow[2] - pow[50]);
    let domain17 = temp * (domain14);
    let mut temp = pow[2] - pow[27];
    temp = temp * (pow[2] - pow[30]);
    temp = temp * (pow[2] - pow[33]);
    let domain18 = temp * (domain15);
    let domain19 = pow[1] - FELT_1;
    let domain20 = pow[1] - pow[20];
    let domain21 = pow[1] - pow[50];
    let domain22 = pow[0] - pow[19];
    let domain23 = pow[0] - FELT_1;
    let domain24 = point - pow[18];
    let domain25 = point - FELT_1;
    let domain26 = point - pow[17];
    let domain27 = point - pow[16];
    let domain28 = point - pow[15];
    let domain29 = point - pow[14];
    let domain30 = point - pow[13];
    ...
    let cpu_decode_opcode_range_check_bit_0: &Felt =
        &Box::new(column0_row0 - (column0_row1 + column0_row1));
    let cpu_decode_opcode_range_check_bit_2: &Felt =
        &Box::new(column0_row2 - (column0_row3 + column0_row3));
    let cpu_decode_opcode_range_check_bit_4: &Felt =
        &Box::new(column0_row4 - (column0_row5 + column0_row5));
    let cpu_decode_opcode_range_check_bit_3: &Felt =
        &Box::new(column0_row3 - (column0_row4 + column0_row4));
    let cpu_decode_flag_op1_base_op0_0: &Felt = &Box::new(
        FELT_1
            - (cpu_decode_opcode_range_check_bit_2
                + cpu_decode_opcode_range_check_bit_4
                + cpu_decode_opcode_range_check_bit_3),
    );
    let cpu_decode_opcode_range_check_bit_5: &Felt =
        &Box::new(column0_row5 - (column0_row6 + column0_row6));
    let cpu_decode_opcode_range_check_bit_6: &Felt =
        &Box::new(column0_row6 - (column0_row7 + column0_row7));
    let cpu_decode_opcode_range_check_bit_9: &Felt =
        &Box::new(column0_row9 - (column0_row10 + column0_row10));
    let cpu_decode_flag_res_op1_0: &Felt = &Box::new(
        FELT_1
            - (cpu_decode_opcode_range_check_bit_5
                + cpu_decode_opcode_range_check_bit_6
                + cpu_decode_opcode_range_check_bit_9),
    );
    let cpu_decode_opcode_range_check_bit_7: &Felt =
        &Box::new(column0_row7 - (column0_row8 + column0_row8));
    let cpu_decode_opcode_range_check_bit_8: &Felt =
        &Box::new(column0_row8 - (column0_row9 + column0_row9));
    let cpu_decode_flag_pc_update_regular_0: &Felt = &Box::new(
        FELT_1
            - (cpu_decode_opcode_range_check_bit_7
                + cpu_decode_opcode_range_check_bit_8
                + cpu_decode_opcode_range_check_bit_9),
    );
    let cpu_decode_opcode_range_check_bit_12: &Felt =
        &Box::new(column0_row12 - (column0_row13 + column0_row13));
    let cpu_decode_opcode_range_check_bit_13: &Felt =
        &Box::new(column0_row13 - (column0_row14 + column0_row14));
    let cpu_decode_fp_update_regular_0: &Felt = &Box::new(
        FELT_1 - (cpu_decode_opcode_range_check_bit_12 + cpu_decode_opcode_range_check_bit_13),
    );
    let cpu_decode_opcode_range_check_bit_1: &Felt =
        &Box::new(column0_row1 - (column0_row2 + column0_row2));
    let npc_reg_0 = column1_row0 + cpu_decode_opcode_range_check_bit_2 + FELT_1;
    let cpu_decode_opcode_range_check_bit_10: &Felt =
        &Box::new(column0_row10 - (column0_row11 + column0_row11));
    let cpu_decode_opcode_range_check_bit_11: &Felt =
        &Box::new(column0_row11 - (column0_row12 + column0_row12));
    let cpu_decode_opcode_range_check_bit_14: &Felt =
        &Box::new(column0_row14 - (column0_row15 + column0_row15));
    let memory_address_diff_0: &Felt = &Box::new(column2_row2 - column2_row0);
    let range_check16_diff_0: &Felt = &Box::new(column4_row6 - column4_row2);
    let pedersen_hash0_ec_subset_sum_bit_0: &Felt =
        &Box::new(column4_row3 - (column4_row11 + column4_row11));
    let pedersen_hash0_ec_subset_sum_bit_neg_0: &Felt =
        &Box::new(FELT_1 - pedersen_hash0_ec_subset_sum_bit_0);
    let range_check_builtin_value0_0: &Felt = &Box::new(column4_row12);
    let range_check_builtin_value1_0: &Felt =
        &Box::new(range_check_builtin_value0_0 * global_values.offset_size + column4_row44);
    let range_check_builtin_value2_0: &Felt =
        &Box::new(range_check_builtin_value1_0 * global_values.offset_size + column4_row76);
    let range_check_builtin_value3_0: &Felt =
        &Box::new(range_check_builtin_value2_0 * global_values.offset_size + column4_row108);
    let range_check_builtin_value4_0: &Felt =
        &Box::new(range_check_builtin_value3_0 * global_values.offset_size + column4_row140);
    let range_check_builtin_value5_0: &Felt =
        &Box::new(range_check_builtin_value4_0 * global_values.offset_size + column4_row172);
    let range_check_builtin_value6_0: &Felt =
        &Box::new(range_check_builtin_value5_0 * global_values.offset_size + column4_row204);
    let range_check_builtin_value7_0: &Felt =
        &Box::new(range_check_builtin_value6_0 * global_values.offset_size + column4_row236);
    let bitwise_sum_var_0_0: &Felt = &Box::new(
        column3_row0
            + column3_row4 * FELT_2
            + column3_row8 * FELT_4
            + column3_row12 * FELT_8
            + column3_row16 * FELT_18446744073709551616
            + column3_row20 * FELT_36893488147419103232
            + column3_row24 * FELT_73786976294838206464
            + column3_row28 * FELT_147573952589676412928,
    );
    let bitwise_sum_var_8_0: &Felt = &Box::new(
        column3_row32 * FELT_340282366920938463463374607431768211456
            + column3_row36 * FELT_680564733841876926926749214863536422912
            + column3_row40 * FELT_1361129467683753853853498429727072845824
            + column3_row44 * FELT_2722258935367507707706996859454145691648
            + column3_row48 * FELT_6277101735386680763835789423207666416102355444464034512896
            + column3_row52 * FELT_12554203470773361527671578846415332832204710888928069025792
            + column3_row56 * FELT_25108406941546723055343157692830665664409421777856138051584
            + column3_row60 * FELT_50216813883093446110686315385661331328818843555712276103168,
    );
    let poseidon_poseidon_full_rounds_state0_cubed_0: &Felt =
        &Box::new(column5_row9 * column5_row105);
    let poseidon_poseidon_full_rounds_state1_cubed_0: &Felt =
        &Box::new(column5_row73 * column5_row25);
    let poseidon_poseidon_full_rounds_state2_cubed_0: &Felt =
        &Box::new(column5_row41 * column5_row89);
    let poseidon_poseidon_full_rounds_state0_cubed_7: &Felt =
        &Box::new(column5_row905 * column5_row1001);
    let poseidon_poseidon_full_rounds_state1_cubed_7: &Felt =
        &Box::new(column5_row969 * column5_row921);
    let poseidon_poseidon_full_rounds_state2_cubed_7: &Felt =
        &Box::new(column5_row937 * column5_row985);
    let poseidon_poseidon_full_rounds_state0_cubed_3: &Felt =
        &Box::new(column5_row393 * column5_row489);
    let poseidon_poseidon_full_rounds_state1_cubed_3: &Felt =
        &Box::new(column5_row457 * column5_row409);
    let poseidon_poseidon_full_rounds_state2_cubed_3: &Felt =
        &Box::new(column5_row425 * column5_row473);
    let poseidon_poseidon_partial_rounds_state0_cubed_0: &Felt =
        &Box::new(column5_row6 * column5_row14);
    let poseidon_poseidon_partial_rounds_state0_cubed_1: &Felt =
        &Box::new(column5_row22 * column5_row30);
    let poseidon_poseidon_partial_rounds_state0_cubed_2: &Felt =
        &Box::new(column5_row38 * column5_row46);
    let poseidon_poseidon_partial_rounds_state1_cubed_0: &Felt =
        &Box::new(column5_row1 * column5_row17);
    let poseidon_poseidon_partial_rounds_state1_cubed_1: &Felt =
        &Box::new(column5_row33 * column5_row49);
    let poseidon_poseidon_partial_rounds_state1_cubed_2: &Felt =
        &Box::new(column5_row65 * column5_row81);
    let poseidon_poseidon_partial_rounds_state1_cubed_19: &Felt =
        &Box::new(column5_row609 * column5_row625);
    let poseidon_poseidon_partial_rounds_state1_cubed_20: &Felt =
        &Box::new(column5_row641 * column5_row657);
    let poseidon_poseidon_partial_rounds_state1_cubed_21: &Felt =
        &Box::new(column5_row673 * column5_row689);
    ...
    value = (column0_row0).field_div(&felt_nonzero!(domain4));
    ...
    value = (column1_row8 + global_values.half_offset_size
        - (cpu_decode_opcode_range_check_bit_0 * column5_row8
            + (FELT_1 - cpu_decode_opcode_range_check_bit_0) * column5_row0
            + column4_row0))
        .field_div(&felt_nonzero!(domain5));
    ...
    value = (column1_row4 + global_values.half_offset_size
        - (cpu_decode_opcode_range_check_bit_1 * column5_row8
            + (FELT_1 - cpu_decode_opcode_range_check_bit_1) * column5_row0
            + column4_row8))
        .field_div(&felt_nonzero!(domain5));
    ...
    value = (column5_row4 - column1_row5 * column1_row13).field_div(&felt_nonzero!(domain5));
    total_sum = total_sum + constraint_coefficients[10] * value;

    // Constraint: cpu/operands/res.
    value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column5_row12
    ...
    value = (column5_row2 - cpu_decode_opcode_range_check_bit_9 * column1_row9)
        * domain24.field_div(&felt_nonzero!(domain5));
    ...
    value = ((FELT_1 - cpu_decode_opcode_range_check_bit_9) * column1_row16
    ...
    value = (column5_row24
        - (cpu_decode_fp_update_regular_0 * column5_row8
            ...
            + cpu_decode_opcode_range_check_bit_12 * (column5_row0 + FELT_2)))
        * domain24.field_div(&felt_nonzero!(domain5));
    ...
    value = (cpu_decode_opcode_range_check_bit_12
        * (column1_row5 - (column1_row0 + cpu_decode_opcode_range_check_bit_2 + FELT_1)))
        .field_div(&felt_nonzero!(domain5));
    ...
    value = (cpu_decode_opcode_range_check_bit_12
        * (column4_row8 - (global_values.half_offset_size + FELT_1)))
        .field_div(&felt_nonzero!(domain5));
    ...
    value = (cpu_decode_opcode_range_check_bit_13
        * (column4_row0 + FELT_2 - global_values.half_offset_size))
        .field_div(&felt_nonzero!(domain5));
    total_sum = total_sum + constraint_coefficients[23] * value;

    // Constraint: cpu/opcodes/ret/off2.
    value = (cpu_decode_opcode_range_check_bit_13
        * (column4_row4 + FELT_1 - global_values.half_offset_size))
        .field_div(&felt_nonzero!(domain5));
    ...
    value = (column5_row0 - global_values.initial_ap).field_div(&felt_nonzero!(domain25));
    total_sum = total_sum + constraint_coefficients[27] * value;

    // Constraint: initial_fp.
    value = (column5_row8 - global_values.initial_ap).field_div(&felt_nonzero!(domain25));
    total_sum = total_sum + constraint_coefficients[28] * value;

    // Constraint: initial_pc.
    value = (column1_row0 - global_values.initial_pc).field_div(&felt_nonzero!(domain25));
    total_sum = total_sum + constraint_coefficients[29] * value;

    // Constraint: final_ap.
    value = (column5_row0 - global_values.final_ap).field_div(&felt_nonzero!(domain24));
    total_sum = total_sum + constraint_coefficients[30] * value;

    // Constraint: final_fp.
    value = (column5_row8 - global_values.initial_ap).field_div(&felt_nonzero!(domain24));
    total_sum = total_sum + constraint_coefficients[31] * value;

    // Constraint: final_pc.
    value = (column1_row0 - global_values.final_pc).field_div(&felt_nonzero!(domain24));
    ...
    value = ((global_values.memory_multi_column_perm_perm_interaction_elm
        ...
        * column6_inter1_row2
        - (global_values.memory_multi_column_perm_perm_interaction_elm
            ...
            * column6_inter1_row0)
        * domain26.field_div(&felt_nonzero!(domain1));
    ...
    value = (column6_inter1_row0 - global_values.memory_multi_column_perm_perm_public_memory_prod)
        .field_div(&felt_nonzero!(domain26));
    ...
    value = ((global_values.range_check16_perm_interaction_elm - column4_row6)
        ...
        * domain27.field_div(&felt_nonzero!(domain2));
    ...
    value = (column7_inter1_row1 - global_values.range_check16_perm_public_memory_prod)
        .field_div(&felt_nonzero!(domain27));
    ...
    value = (column4_row2 - global_values.range_check_min).field_div(&felt_nonzero!(domain25));
    total_sum = total_sum + constraint_coefficients[45] * value;

    // Constraint: range_check16/maximum.
    value = (column4_row2 - global_values.range_check_max).field_div(&felt_nonzero!(domain27));
    ...
    value = (column6_inter1_row1 - FELT_1).field_div(&felt_nonzero!(domain25));
    total_sum = total_sum + constraint_coefficients[50] * value;

    // Constraint: diluted_check/first_element.
    value =
        (column3_row1 - global_values.diluted_check_first_elm).field_div(&felt_nonzero!(domain25));
    ...
    value = (column5_row57
        * (column4_row11
            - FELT_3138550867693340381917894711603833208051177722232017256448 * column4_row1539))
        .field_div(&felt_nonzero!(domain19));
    ...
    value = (column4_row2047 * (column4_row1547 - FELT_8 * column4_row1571))
        .field_div(&felt_nonzero!(domain19));
    ...
    value = ((column4_row2011 - (column4_row2019 + column4_row2019))
        * (column4_row1579 - FELT_18014398509481984 * column4_row2011))
        .field_div(&felt_nonzero!(domain19));
    ...
    value =
        (column1_row42 - global_values.initial_bitwise_addr).field_div(&felt_nonzero!(domain25));
    total_sum = total_sum + constraint_coefficients[82] * value;

    // Constraint: bitwise/step_var_pool_addr.
    value =
        (column1_row106 - (column1_row42 + FELT_1)) * domain10.field_div(&felt_nonzero!(domain7));
    total_sum = total_sum + constraint_coefficients[83] * value;

    // Constraint: bitwise/x_or_y_addr.
    value = (column1_row74 - (column1_row234 + FELT_1)).field_div(&felt_nonzero!(domain9));
    total_sum = total_sum + constraint_coefficients[84] * value;

    // Constraint: bitwise/next_var_pool_addr.
    value =
        (column1_row298 - (column1_row74 + FELT_1)) * domain29.field_div(&felt_nonzero!(domain9));
    ...
    value = (column1_row75 - (column1_row171 + column1_row235)).field_div(&felt_nonzero!(domain9));
    ...
    value = (column5_row137
        ...
        * domain13.field_div(&felt_nonzero!(domain8));
    ...
    value = (column5_row97
        ...
        * domain18.field_div(&felt_nonzero!(domain6));

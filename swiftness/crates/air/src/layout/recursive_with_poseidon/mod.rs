...
pub const LAYOUT_CODE: Felt = felt_hex!("0x7265637572736976655f776974685f706f736569646f6e");
...
impl LayoutTrait for Layout {
    ...
    fn eval_composition_polynomial(
        ...
        let global_values = Box::new(GlobalValues {
    ...
    fn verify_public_input(
        ...
        //     .collect::<Vec<Felt>>();
        let memory = public_input.main_page.0.as_slice();
        ...
        let output = memory[memory.len() - output_len..].iter().map(|m| m.value).collect();

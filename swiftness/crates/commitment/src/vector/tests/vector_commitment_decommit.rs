...
use crate::vector::{
    config::Config,
    decommit::vector_commitment_decommit,
    types::{Commitment, Query, Witness},
};
...
fn test_vector_commitment_decommit() {
    ...
    let queries = vec![
        Query {
            index: Felt::from_hex("0x73").unwrap(),
            value: Felt::from_hex(
                "0x12346ea425a6aebc8c323a401410cc325aabaf99b54e600a7271f146488aa2d",
            )
            .unwrap(),
        },
        Query {
            index: Felt::from_hex("0xa5").unwrap(),
            value: Felt::from_hex(
                "0x1aabe006a27bfa5f93bde192ff552adbef87058e62546c831ed14ce94866ac1",
            )
            .unwrap(),
        },
        Query {
            index: Felt::from_hex("0xb0").unwrap(),
            value: Felt::from_hex(
                "0x7205a2b5f5f403b8053b4e4ac65e2a484c007f6d118524fe28b7cdf2a56bb8a",
            )
            .unwrap(),
        },
        Query {
            index: Felt::from_hex("0xf8").unwrap(),
            value: Felt::from_hex(
                "0x5d49462d844a3f203c59d39fa005cbe153c78e6ac831987f19c0d6dfae38fad",
            )
            .unwrap(),
        },
        Query {
            index: Felt::from_hex("0x115").unwrap(),
            value: Felt::from_hex(
        ...
        Query {
            index: Felt::from_hex("0x11c").unwrap(),
            value: Felt::from_hex(
        ...
        Query {
            index: Felt::from_hex("0x12f").unwrap(),
            value: Felt::from_hex(
                "0xb6f3a522577229ac26f12df90daaf376afbd960ee4b0ab07f270bf9c5da56a",
            )
            .unwrap(),
        },
        Query {
            index: Felt::from_hex("0x13c").unwrap(),
            value: Felt::from_hex(
        ...
        Query {
            index: Felt::from_hex("0x153").unwrap(),
            value: Felt::from_hex(
        ...
        Query {
            index: Felt::from_hex("0x1f4").unwrap(),
            value: Felt::from_hex(
    ...
    let witness = Witness {
        authentications: FunVec::from_vec(vec![
            ...
            Felt::from_hex("0xf3fb7305323c5fa68ad49a509a9c470e2396af41bfd2c9cf86228504436a3")
                .unwrap(),
            Felt::from_hex("0x9dc63f0ac48b17304af16748798567f21bb25f8cbeaa48a462a74b3e0c5d79")
                .unwrap(),
            ...
            Felt::from_hex("0x63c1598794322bd8f1686e89c94dc60b0bb4f7940b5427af72187091e71ef63")
                .unwrap(),
            Felt::from_hex("0xebaa8e9ab29cfba43cdc1f2cacb9cbc08b2cb17317fed571718e5e66b42488")
                .unwrap(),
            Felt::from_hex("0xa31370f89d85108378244beeea13a2b2c379d16cde55c2fcd674f4296ddabe")
                .unwrap(),
            ...
            Felt::from_hex("0x4253b3498a013d4473d43686f9e509be7541daf00afae0d7216f7019bc75d8f")
                .unwrap(),
            Felt::from_hex("0x689297a643de6bd5955e314f94367af901eac67eeef51a52e40c0205cf8023")
                .unwrap(),
            Felt::from_hex("0x2ca9dcef95643af6ec5ee055d1a05720f2e3f5e6226de5b206c4a78482963b8")
                .unwrap(),
            Felt::from_hex("0x72fbddae565406f284bb4dd89623c29c821b6187dd7dfc292dbbddd4094077")
                .unwrap(),
            ...
            Felt::from_hex("0x45ba1eda942e1085af97db6e189996903cfa09db90e52b4589e16df981f1601")
                .unwrap(),
            Felt::from_hex("0x8c36a69368bea30f8ecf7de3e461a03b0cdd004ae08a3d44281b093fc63f2")
                .unwrap(),
            ...
            Felt::from_hex("0x18add43c036948c8d7e767ae22056e1f5f1a9d1daad6b9a8f2e7da996f4a1c2")
                .unwrap(),
            Felt::from_hex("0x30e7224d1c98b75e019b60bbe320e358ef35b1adaf12aad044744e640c2a4d")
                .unwrap(),
            Felt::from_hex("0x25a8793c928ecacb2e84802830fa101fb3839455957921ed7bcb39549b1f80")
                .unwrap(),
            ...
            Felt::from_hex("0x4a50e2b14315602b8c97c9d2304db828806c37b751203bb7dad534d7b45d21d")
                .unwrap(),
            Felt::from_hex("0x5afdcfcf55c58dbf5ad58b17f16514da8dac3e69501fb399c30333ab3050c3")
                .unwrap(),
            ...
            Felt::from_hex("0x5c533c05cbf2af6d819bdf23272e567b7a49c2c2bd799201ed0e32ce9ff092b")
                .unwrap(),
            Felt::from_hex("0x342bb671b7d40601d4031045068abfbf2c578f7e4a380e180dbf2b0c8fef6")
                .unwrap(),
